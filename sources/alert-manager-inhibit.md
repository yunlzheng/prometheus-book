...
![创建静默规则](http://p2n2em8ut.bkt.clouddn.com/alertmanager-new-slicense.png)
...
![活动的静默规则](http://p2n2em8ut.bkt.clouddn.com/alertmanager-active-silences.png)

当静默规则生效以后，从Alertmanager的Alerts页面下用户将不会看到该规则匹配到的告警信息。

![告警信息](http://p2n2em8ut.bkt.clouddn.com/alertmanager-slicense-alerts-result.png)
