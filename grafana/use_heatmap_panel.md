...
![Heatmap示例](./static/grafana_heatmap_sample.png)
...
![Heapmap Panel编辑页面](./static/grafana_heatmap_editor.png)
...
![Metrics设置](./static/grafana_heatmap_normal_metrics.png)

并且通过**Axes选项**中选择**Data format**方式为**Time series**。设置该选项后Heatmap Panel会要求用户提供Bucket分布范围的设置，如下所示：

![Axes设置](./static/grafana_heatmap_normal_axes.png)
...
![Bucket分布情况](./static/grafana_heatmap_normal_sample.png)
